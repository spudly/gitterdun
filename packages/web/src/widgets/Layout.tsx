					...
					<div className="flex h-16 items-center justify-between">
						<div className="flex items-center">
							<h1 className="text-2xl font-bold text-indigo-600">
								<FormattedMessage id="app.name" defaultMessage="Gitterdun" />
							</h1>
						...
						<div className="flex items-center space-x-4">
							<div className="flex items-center space-x-2">
								<span className="text-sm text-gray-600">
									{intl.formatMessage({id: 'header.points', defaultMessage: 'Points'})}:
								</span>
							...
							<div className="flex items-center space-x-2">
								<span className="text-sm text-gray-600">
									{intl.formatMessage({id: 'header.streak', defaultMessage: 'Streak'})}:
								</span>
							...
							<div className="flex items-center space-x-2">
								...
								<span className="text-sm font-medium text-gray-700">
									{user?.username ?? intl.formatMessage({id: 'header.user', defaultMessage: 'User'})}
								</span>
							</div>

							<div className="flex items-center">
								<button
									aria-label={intl.formatMessage({id: 'header.language', defaultMessage: 'Language'})}
									className="rounded px-2 py-1 text-sm"
									onClick={() => {
										const next = locale === 'en' ? 'pirate' : locale === 'pirate' ? 'piglatin' : 'en';
										setLocale(next);
									}}
									title={intl.formatMessage({id: 'header.language', defaultMessage: 'Language'})}
									type="button"
								>
