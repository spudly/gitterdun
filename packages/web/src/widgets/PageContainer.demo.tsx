        ...
        <div className="rounded-lg border-2 border-dashed border-gray-300 p-4">
          <PageContainer variant="centered">
            <div className="flex flex-col gap-4 rounded-lg bg-white p-6 shadow">
              <h2 className="text-2xl font-semibold">Centered Content</h2>
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="rounded-lg bg-white/80 p-6 shadow backdrop-blur-sm">
                <p className="text-gray-700">
                  This page container has custom background styling applied
                  while maintaining the base layout structure.
                </p>
              </div>
            </div>
          </PageContainer>
